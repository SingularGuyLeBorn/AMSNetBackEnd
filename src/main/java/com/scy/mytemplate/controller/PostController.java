...
import com.scy.mytemplate.model.dto.post.PostAddRequest;
import com.scy.mytemplate.model.dto.post.PostEditRequest;
import com.scy.mytemplate.model.dto.post.PostQueryRequest;
import com.scy.mytemplate.model.dto.post.PostUpdateRequest;
...
public class PostController {
    ...
    public BaseResponse<Boolean> editPost(@RequestBody PostEditRequest postEditRequest, HttpServletRequest request) {
        if (postEditRequest == null || postEditRequest.getId() == null ){
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        Post post = new Post();
